...
export const PARTNERS: Partner[] = [
  // ── Getting Settled ─────────────────────────────────────────────────────
  {
    ...
    howToStart: 'For settlement services, email newcomers@dcrs.ca or call 604-507-6060. General enquiries: 604-597-0205.',
    phone: '604-597-0205',
    email: 'info@dcrs.ca',
    ...
    programs: [
      {
        ...
        description: 'Help with settling in, from housing navigation to connecting with community supports.',
        eligibility: 'Permanent residents, refugees and protected persons through IRCC funding; temporary residents, international students, naturalized citizens and refugee claimants through the BC Newcomer Services Program.',
        cost: 'free',
      ...
      },
      {
        ...
        description: 'Job search support and employment programs for newcomers.',
        url: 'https://www.dcrs.ca/our-services/employment-programs/',
      },
      {
        name: 'Mental Health and Substance Use Services',
        description: 'Counselling and support. Intake: 604-547-1202, intake@dcrs.ca.',
        url: 'https://www.dcrs.ca/our-services/mental-health-and-substance-use-services/',
      },
      {
        name: 'Language Testing Centre (CELPIP)',
        description: 'CELPIP language testing for immigration and citizenship applications.',
  ...
  },
  {
    ...
    howToStart: 'Call or email the nearest house. For settlement services, contact settlementprogram@burnabynh.ca or 604-431-0400.',
    phone: '(604) 431-0400',
    email: 'receptiona@burnabynh.ca',
    address: '#100 – 4460 Beresford St, Burnaby, BC V5H 0B8',
    hours: 'South House Mon–Fri 9:00am–5:00pm · North House Mon–Fri 9:30am–4:30pm · Brentwood House Mon–Fri 9:00am–4:00pm',
    programs: [
      {
        name: 'Newcomers Settlement Services',
        description: 'Settlement plans, benefit applications, language support and community connections.',
        eligibility: 'Funded by IRCC and, in accordance with their requirements, focused on supporting permanent residents and convention refugees.',
  ...
  },
  {
    ...
    cost: 'mixed',
    howToStart: 'Call 604-681-9622 or email information.request@ymcabc.ca. Individual programs have their own registration forms.',
    phone: '604-681-9622',
    ...
    programs: [
      {
        ...
        description: 'Free program to help overcome employment barriers in Canada.',
        cost: 'free',
      },
      {
      ...
      },
      {
        ...
        description: 'Fully funded business coaching to help you launch and grow a small business.',
        cost: 'free',
      },
      {
        name: 'TradeWorks',
      ...
      {
        name: 'InterviewME',
        description: 'Helps job seekers connect with the right people at the right time.',
      },
    ],
    displayOrder: 2,
    active: true,
  ...
  // ── Find Work ───────────────────────────────────────────────────────────
  {
    ...
    programs: [
      {
        name: 'MentorConnect',
        description: 'One-on-one, occupation-specific coaching that pairs job-ready newcomers with established local professionals.',
        eligibility: 'Newcomers to Canada within the past 10 years who are eligible to work and have a job-ready resume. You must be in BC or planning to move to BC.',
        cost: 'free',
        url: 'https://iecbc.ca/our-work/programs/mentorconnect/',
      },
      {
        name: 'TalentConnect',
        description: 'Connects BC employers with globally trained professionals through tailored hiring and networking opportunities.',
        eligibility: 'Permanent residents in Canada, and those approved for immigration who have yet to land.',
        cost: 'free',
        url: 'https://iecbc.ca/our-work/programs/talentconnect/',
      },
      {
        name: 'ASCEND',
        description: 'Online, self-paced learning to build the workplace soft skills Canadian employers look for (English & French).',
        cost: 'free',
        url: 'https://ascendemployment.com/participants/',
      },
      {
        name: 'FAST',
        description: 'Helps newcomers see how their experience and training meet Canadian standards, with career-prep streams by field.',
        cost: 'free',
  ...
  },
  {
    ...
    cost: 'mixed',
    howToStart: 'Create an account online, upload your resume and apply for jobs on the website.',
    phone: '(306) 229-6774',
    ...
    programs: [
      {
        ...
        description: 'Consultation on employer employment needs, with a scheduled 30-minute orientation.',
      },
    ],
    displayOrder: 0,
    active: true,
    ...
    programs: [
      {
        ...
        description: 'Help sponsoring a spouse, partner, children or parents for permanent residency.',
      },
    ],
    displayOrder: 1,
    active: true,
    ...
    programs: [
      {
        ...
        description: 'A guide to settlement, employment, English learning and citizenship services in Burnaby and nearby.',
  ...
  },
  {
    ...
    hours: 'Newcomer Welcome Centre: Mon–Thu 10:00am–9:00pm · Fri–Sat 10:00am–5:00pm',
    languages: [
      'Arabic',
      'Cantonese',
      'Dari',
    ...
    programs: [
      {
        ...
        description: 'Settlement workers help you look for a job, find housing and start your life in Canada.',
        eligibility: 'No status restriction is stated. Services are delivered by partner agencies — call ahead to confirm times and locations.',
        cost: 'free',
        url: 'https://www.surreylibraries.ca/programs-services/newcomers',
      },
      {
        name: 'Newcomer Library Services',
        description: 'English language learning tools and connections to settlement services, free at all branches.',
        eligibility: 'Free and available at all branches. No immigration-status restriction is stated.',
        cost: 'free',
      },
      {
        name: 'Get a Library Card',
        description: 'Free library cards for all ages. Bring ID to any branch.',
        eligibility: 'You can become a member if you live in Surrey or a neighbouring community. Digital resources are for Surrey residents only.',
        cost: 'free',
      },
    ],
    displayOrder: 1,
  ...
  // ── Community & Belonging ───────────────────────────────────────────────
  {
    ...
    cost: 'free',
    howToStart: 'Use the "Find an agency near you" locator on their website to reach your local agency.',
    programs: [
      {
        name: 'Community-Based 1:1 Mentoring',
        description: 'Mentee and mentor explore their local community together, around 6–8 hours a month.',
        cost: 'free',
      },
      {
        name: 'Site-Based 1:1 Mentoring',
        description: 'Mentor and mentee meet weekly at a set location such as a school, working towards set goals.',
        cost: 'free',
      },
      {
        name: 'Go Girls! Healthy Bodies, Healthy Minds',
        description: 'Group mentoring on physical activity, healthy eating and self-esteem, over seven sessions.',
        eligibility: 'Girls ages 12–14.',
        cost: 'free',
      },
      {
        name: 'Game On! Eat Smart, Play Smart',
        description: 'Group mentoring giving boys and young men support to make informed healthy choices.',
  ...
  },
  {
    ...
    howToStart: 'Call, email info@uwbc.ca, or use the contact form on their website.',
    phone: '604.294.8929',
    email: 'info@uwbc.ca',
    ...
    programs: [
      {
        ...
        description: 'Supports refugee claimants through volunteer mobilisations and public appeals for housing and services.',
        eligibility: 'Refugee claimants.',
      },
      {
        name: 'Better at Home',
        description: 'Non-medical help for seniors — groceries, housekeeping and social connection — in 260+ communities.',
      },
      {
      ...
      {
        name: 'School\'s Out',
        description: 'Out-of-school-time wellness, nutrition and developmental support for children.',
  ...
  },
  {
    ...
    cost: 'mixed',
    howToStart: 'Register online through the City of Vancouver recreation system, or drop in and ask at the front desk.',
    phone: '604-257-6955',
    ...
    programs: [
      {
        ...
        description: 'City of Vancouver subsidy giving reduced-cost access to recreation.',
        eligibility: 'Low-income Vancouver residents holding a valid leisure access card.',
      },
      {
        name: 'TLCCA Program Cost Assistance',
        description: 'Help with program fees for community members in financial need.',
        eligibility: 'Community members in financial need who are not eligible for LAP.',
      },
      {
  ...
  // ── Networks & Planning Tables ──────────────────────────────────────────
  {
    ...
    cost: 'mixed',
    howToStart: 'Email amssa@amssa.org or use the contact form. AMSSA works with organizations, not individuals.',
    phone: '604-718-2780',
    ...
    programs: [
      {
        ...
        description: 'Indirect support to organizations and institutions funded by IRCC.',
      },
      {
        name: 'Migrant Worker Hub',
        description: 'Builds the capacity of organizations supporting migrant workers in BC.',
      },
      {
        name: 'AMSSA Institute',
        description: 'Online learning centre — webinars, AMSSATalks and e-learning for sector staff.',
      },
      {
        name: 'National Sector Engagement',
        description: 'Coordinates national engagement initiatives across the settlement sector.',
      },
      {
        name: 'Canadian Humanitarian Assistance Response (CHAR)',
        description: 'A network of community-based service providers offering essential supports across Canada.',
      },
    ],
    displayOrder: 0,
    active: true,
  },
  {
    ...
    howToStart: 'Use the contact form on their website, or join one of the working groups or round tables. Surrey LIP works with agencies, not individuals.',
    programs: [
      {
      ...
      },
      {
        ...
        description: 'Community connector streams with referral contacts for specific communities.',
      },
    ],
    displayOrder: 1,
    active: true,
