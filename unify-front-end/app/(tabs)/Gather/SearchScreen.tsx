...
const SearchScreen = () => {
  ...
  let foundPost = filterPosts && filterPosts.length > 0;
  ...
  if (recentSearches.length > 0) {
    searchHistory = (
      <View style={{ marginTop: 10 }}>
        <Text style={styles.emptyText}> Recent Searches </Text>
  ...
  if (recentGroups.length > 0) {
    groupsHistory = (
      <View>
        <Text style={styles.emptyText}>Recently Accessed Groups</Text>
  ...
  return (
    <View style={styles.searchContainer}>
      ...
      {searchQuery && foundPost && (
        <View>
          <Text style={styles.emptyText}>POSTS</Text>
          <FlatList
            data={filterPosts}
