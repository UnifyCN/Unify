-- ============================================================================
-- Add resilient cron auth for the live matchmake-circles slug
-- ============================================================================
...
begin
  ...
  perform net.http_post(
    ...
    headers := jsonb_build_object(
      ...
      when _matchmake_api_key is not null and _matchmake_api_key <> '' then
        jsonb_build_object('x-api-key', _matchmake_api_key)
      else
        '{}'::jsonb
    end,
    body := '{}'::jsonb,
